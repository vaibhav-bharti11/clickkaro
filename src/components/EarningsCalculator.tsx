      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mb-12">
          <div className="bg-white/80 backdrop-blur-xl p-5 rounded-3xl border border-pink-200/70 shadow-sm text-center">
            <div className="text-2xl sm:text-3xl font-bold text-[#1d1d1f] mb-0.5 tabular-numbers">₹2,000+</div>
            <div className="text-xs text-[#86868b] font-medium">Avg Hourly Rate</div>
          </div>
          <div className="bg-white/80 backdrop-blur-xl p-5 rounded-3xl border border-pink-200/70 shadow-sm text-center">
            <div className="text-2xl sm:text-3xl font-bold text-emerald-600 mb-0.5 tabular-numbers">80%</div>
            <div className="text-xs text-[#86868b] font-medium">You Keep Take-Home</div>
          </div>
          <div className="bg-white/80 backdrop-blur-xl p-5 rounded-3xl border border-pink-200/70 shadow-sm text-center">
            <div className="text-2xl sm:text-3xl font-bold text-[#0071e3] mb-0.5 tabular-numbers">Weekly</div>
            <div className="text-xs text-[#86868b] font-medium">Direct Bank Payouts</div>
          </div>
          <div className="bg-white/80 backdrop-blur-xl p-5 rounded-3xl border border-pink-200/70 shadow-sm text-center">
            <div className="text-2xl sm:text-3xl font-bold text-pink-600 mb-0.5 tabular-numbers">₹199</div>
            <div className="text-xs text-[#86868b] font-medium">Launch Pass (60% OFF)</div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center bg-white/85 backdrop-blur-2xl rounded-3xl p-6 sm:p-10 border border-pink-200/80 shadow-apple-lg">
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="flex items-center gap-3 pb-4 border-b border-pink-100">
              ...
              <div>
                <h3 className="text-lg font-bold text-[#1d1d1f]">Live Earnings Simulator</h3>
                <p className="text-xs text-[#86868b]">Select your hourly rate and availability to project your earnings</p>
              </div>
            </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                <label htmlFor="earnings-rate-slider" className="text-xs font-semibold text-[#1d1d1f]">Hourly Rate (₹)</label>
                <span className="text-base font-bold text-[#0071e3] tabular-numbers">₹{hourlyRate.toLocaleString('en-IN')}/hr</span>
              </div>
              <input 
              ...
              <div className="flex justify-between text-[10px] text-[#86868b] mt-1 tabular-numbers">
                <span>₹1,000 (Elder Care)</span>
                <span>₹2,000 (Social)</span>
                <span>₹4,500 (Events)</span>
              </div>
            </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                <label htmlFor="earnings-hours-slider" className="text-xs font-semibold text-[#1d1d1f]">Hours Available Per Week</label>
                <span className="text-base font-bold text-pink-700 tabular-numbers">{hoursPerWeek} Hours / Week</span>
              </div>
              <input 
                id="earnings-hours-slider"
                type="range"
                min="5"
                max="40"
                step="5"
            ...
            <div className="p-3.5 bg-pink-50/70 rounded-2xl border border-pink-100 text-xs text-[#1d1d1f]/80 flex items-start gap-2">
              ...
              <span>Full control &mdash; reject any request with zero penalty. Only accept meetups that fit your schedule.</span>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 bg-[#121214] text-white rounded-3xl p-6 sm:p-8 shadow-apple-md border border-white/10 flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between mb-4">
                <span className="text-xs font-bold text-pink-400 uppercase tracking-wider flex items-center gap-1">
                  <TrendingUp className="w-3.5 h-3.5" /> Payout Projection
                </span>
              ...
              <div className="space-y-2 text-xs text-[#86868b] pt-4 border-t border-white/10 mb-6">
                <div className="flex justify-between">
                  ...
                  <span className="text-white font-medium tabular-numbers">₹{weeklyGross.toLocaleString('en-IN')}</span>
                </div>
                <div className="flex justify-between">
            ...
            >
              <span>Apply for Partner Launch Pass</span>
